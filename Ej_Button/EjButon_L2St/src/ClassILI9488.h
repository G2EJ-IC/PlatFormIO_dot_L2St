...
public:
  LGFX(void)
  {
    { // Configurar los ajustes de control del bus.
      ...
      //Pines GPIO
      cfg.pin_sclk = 18;          // Establecer el número de pin SPI SCLK
      cfg.pin_mosi = 23;          // Establece el número de pin SPI MOSI
      cfg.pin_miso = 19;          // Establece el número de pin SPI MISO (-1 = desactivar)
      cfg.pin_dc   = 2;          // Establece el número de pin SPI D/C (-1 = desactivar)
    ...
    { // Establecer el control del panel de visualización.
      ...
      //Pines GPIO.
      cfg.pin_cs = 15; // Número de pin al que está conectado el CS (-1 = deshabilitar)
      cfg.pin_rst = 4; // Número de pin al que está conectado RST (-1 = deshabilitar)
      cfg.pin_busy = -1; // Número de pin al que está conectado BUSY (-1 = deshabilitar)
    ...
    { // Establecer el control de retroiluminación. (Eliminar si no es necesario)
      ...
      cfg.pin_bl = 32; // Número de pin al que está conectada la retroiluminación
    ...
    { // Configurar los ajustes de control de la pantalla táctil. (Eliminar si no es necesario)
      ...
      cfg.pin_int = -1; // Número de pin al que está conectado INT
      ...
      cfg.pin_sclk = 18; // Número de pin al que está conectado SCLK
      cfg.pin_mosi = 23; // Número de pin al que está conectado MOSI
      cfg.pin_miso = 19; // Número de pin al que está conectado MISO
      cfg.pin_cs = 21; // Número de pin al que está conectado CS
